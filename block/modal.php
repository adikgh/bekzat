	...
	<div class="pop_bl fr">
		...
		<div class="pop_bl_c">
			...
			<div class="form_c">
				...
				<div class="form_im"><input type="text" class="form_im_txt name" placeholder="Введите имя .." ></div>
				<div class="form_im"><input type="tel" class="form_im_txt phone fr_phone" placeholder="8 (___) ___-__-__" ></div>
	...
	<div class="pop_bl fr2">
		...
		<div class="pop_bl_c">
			...
			<div class="form_c">
				...
				<div class="form_im"><input type="tel" placeholder="8 (___) ___-__-__" class="form_im_txt phone fr_phone"></div>
				<div class="form_im"><div class="btn orderSend"><span>Оставить заявку</span></div></div>
			</div>
